...
import 'package:hotel_reservation_app/screens/provinces_page.dart'; // New import
import 'package:hotel_reservation_app/screens/cities_page.dart'; // New import
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/provinces_selection': (context) => const ProvincesPage(), // New route
        // CitiesPage مستقیماً از ProvincesPage فراخوانی می‌شود و نیازی به تعریف route در اینجا ندارد
      },
    );
  }
}
